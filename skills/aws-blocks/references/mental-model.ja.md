---
lang: ja
source: mental-model.md
source_sha: 16c719d748366d164bd8025ebf7da90843caa94a
---

> 📖 これは [mental-model.md](mental-model.md) の日本語訳です。**正典は英語版**で、差異がある場合は英語が優先されます。
...
- **fullId**: `scope/id`（例 `my-app/todos`）。これが**AWSリソース名やローカル`.bb-data/`の
  ...
  （→ rules-and-gotchas.ja.md のデータ消失参照）。
